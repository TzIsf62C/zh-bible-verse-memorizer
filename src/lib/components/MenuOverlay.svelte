<script>
	...
	const icons = {
		...
		stats: '<path stroke-linecap="round" stroke-linejoin="round" d="M3 7h8m-8 4h13m-13 4h18"/><circle cx="19.5" cy="7" r="1.5"/><circle cx="19.5" cy="11" r="1.5"/><circle cx="19.5" cy="15" r="1.5"/>',
		flame: '<path stroke-linecap="round" stroke-linejoin="round" d="M12 3c-1.5 3-3 4.5-3 7.5 0 2.5 1.5 4.5 3 4.5s3-2 3-4.5c0-3-1.5-4.5-3-7.5z"/><path stroke-linecap="round" stroke-linejoin="round" d="M12 15c-.75 1.5-1.5 2.25-1.5 3.75 0 1.25.75 2.25 1.5 2.25s1.5-1 1.5-2.25c0-1.5-.75-2.25-1.5-3.75z"/>',
