export const translations = {
	english: {
		...
		locked: 'Locked',
		achievement_learned_10_verses: 'Verse Learner I',
		achievement_learned_10_verses_desc: 'Learn 10 verses.',
		achievement_mastered_10_verses: 'Verse Master I',
		achievement_mastered_10_verses_desc: 'Master 10 verses (interval > 48 days).',
		achievement_learned_1_chapter: 'Chapter Learner',
		achievement_learned_1_chapter_desc: 'Learn every verse in one chapter.',
		achievement_mastered_1_chapter: 'Chapter Master',
		achievement_mastered_1_chapter_desc: 'Master every verse in one chapter.',
		achievement_range_sermon_on_mount: 'Sermon on the Mount',
		achievement_learned_sermon_on_mount: 'Sermon Learner',
		achievement_learned_sermon_on_mount_desc: 'Learn Matthew chapters 5 to 7.',
		achievement_mastered_sermon_on_mount: 'Sermon Master',
		achievement_mastered_sermon_on_mount_desc: 'Master Matthew chapters 5 to 7.',
	...
	simplified: {
		...
		unlocked_on: '解锁时间',
		locked: '未解锁',
		achievement_learned_10_verses: '经文学习者 I',
		achievement_learned_10_verses_desc: '学会 10 节经文。',
		achievement_mastered_10_verses: '经文精通者 I',
		achievement_mastered_10_verses_desc: '精通 10 节经文（间隔 > 48 天）。',
		achievement_learned_1_chapter: '章节学习者',
		achievement_learned_1_chapter_desc: '学会一整章的所有经文。',
		achievement_mastered_1_chapter: '章节精通者',
		achievement_mastered_1_chapter_desc: '精通一整章的所有经文。',
		achievement_range_sermon_on_mount: '登山宝训',
		achievement_learned_sermon_on_mount: '宝训学习者',
		achievement_learned_sermon_on_mount_desc: '学会马太福音第 5 至 7 章。',
		achievement_mastered_sermon_on_mount: '宝训精通者',
		achievement_mastered_sermon_on_mount_desc: '精通马太福音第 5 至 7 章。',
		practice_now: '现在练习',
	...
	traditional: {
		...
		unlocked_on: '解鎖時間',
		locked: '未解鎖',
		achievement_learned_10_verses: '經文學習者 I',
		achievement_learned_10_verses_desc: '學會 10 節經文。',
		achievement_mastered_10_verses: '經文精通者 I',
		achievement_mastered_10_verses_desc: '精通 10 節經文（間隔 > 48 天）。',
		achievement_learned_1_chapter: '章節學習者',
		achievement_learned_1_chapter_desc: '學會一整章的所有經文。',
		achievement_mastered_1_chapter: '章節精通者',
		achievement_mastered_1_chapter_desc: '精通一整章的所有經文。',
		achievement_range_sermon_on_mount: '登山寶訓',
		achievement_learned_sermon_on_mount: '寶訓學習者',
		achievement_learned_sermon_on_mount_desc: '學會馬太福音第 5 至 7 章。',
		achievement_mastered_sermon_on_mount: '寶訓精通者',
		achievement_mastered_sermon_on_mount_desc: '精通馬太福音第 5 至 7 章。',
		practice_now: '現在練習',
