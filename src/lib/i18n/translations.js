export const translations = {
	english: {
		...
		stats_current_totals: 'Current Totals',
		stats_progress_timeline: 'Progress Over Time',
		...
		achievement_book_learned_template: '{book} Learned',
		achievement_book_mastered_template: '{book} Mastered',
		achievement_passage_romans_road_learned: 'Roman\'s Road Learned',
		achievement_passage_romans_highway_mastered: 'Roman\'s Highway Mastered',
		achievement_passage_four_spiritual_laws_learned: 'Four Spiritual Laws Learned',
		achievement_passage_good_news_mastered: 'Good News Mastered',
		achievement_passage_my_shepherd_learned: 'My Shepherd Learned',
		achievement_passage_goodness_mercy_mastered: 'Goodness & Mercy Mastered',
		achievement_passage_hidden_in_heart_learned: 'Hidden in the Heart Learned',
		achievement_passage_sweeter_than_honey_mastered: 'Sweeter than Honey Mastered',
		achievement_passage_sermon_on_mount_learned: 'Sermon on the Mount Learned',
		achievement_passage_kingdom_life_mastered: 'Kingdom Life Mastered',
		achievement_passage_farewell_discourse_learned: 'Farewell Discourse Learned',
		achievement_passage_red_letters_mastered: 'Red Letters Mastered',
		achievement_passage_dead_to_sin_learned: 'Dead to Sin Learned',
		achievement_passage_nothing_separates_mastered: 'Nothing Can Separate Us Mastered',
	...
	simplified: {
		...
		stats_current_totals: '当前总数',
		stats_progress_timeline: '随时间进展',
		...
		achievement_book_learned_template: '{book} 已学会',
		achievement_book_mastered_template: '{book} 已精通',
		achievement_passage_romans_road_learned: '罗马之路已学会',
		achievement_passage_romans_highway_mastered: '罗马大道已精通',
		achievement_passage_four_spiritual_laws_learned: '四个属灵定律已学会',
		achievement_passage_good_news_mastered: '好消息已精通',
		achievement_passage_my_shepherd_learned: '我的牧者已学会',
		achievement_passage_goodness_mercy_mastered: '恩惠慈爱已精通',
		achievement_passage_hidden_in_heart_learned: '藏在心里已学会',
		achievement_passage_sweeter_than_honey_mastered: '比蜜更甜已精通',
		achievement_passage_sermon_on_mount_learned: '登山宝训已学会',
		achievement_passage_kingdom_life_mastered: '天国生活已精通',
		achievement_passage_farewell_discourse_learned: '临别讲论已学会',
		achievement_passage_red_letters_mastered: '红字真言已精通',
		achievement_passage_dead_to_sin_learned: '向罪死已学会',
		achievement_passage_nothing_separates_mastered: '无可隔绝已精通',
		practice_now: '现在练习',
	...
	traditional: {
		...
		stats_current_totals: '目前總數',
		stats_progress_timeline: '隨時間進展',
		...
		achievement_book_learned_template: '{book} 已學會',
		achievement_book_mastered_template: '{book} 已精通',
		achievement_passage_romans_road_learned: '羅馬之路已學會',
		achievement_passage_romans_highway_mastered: '羅馬大道已精通',
		achievement_passage_four_spiritual_laws_learned: '四個屬靈定律已學會',
		achievement_passage_good_news_mastered: '好消息已精通',
		achievement_passage_my_shepherd_learned: '我的牧者已學會',
		achievement_passage_goodness_mercy_mastered: '恩惠慈愛已精通',
		achievement_passage_hidden_in_heart_learned: '藏在心裡已學會',
		achievement_passage_sweeter_than_honey_mastered: '比蜜更甜已精通',
		achievement_passage_sermon_on_mount_learned: '登山寶訓已學會',
		achievement_passage_kingdom_life_mastered: '天國生活已精通',
		achievement_passage_farewell_discourse_learned: '臨別講論已學會',
		achievement_passage_red_letters_mastered: '紅字真言已精通',
		achievement_passage_dead_to_sin_learned: '向罪死已學會',
		achievement_passage_nothing_separates_mastered: '無可隔絕已精通',
		practice_now: '現在練習',
